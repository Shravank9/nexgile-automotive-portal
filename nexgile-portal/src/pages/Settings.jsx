          ...
          <div className="card">
            ...
            <div className="card-body">
              <div style={{display:'flex',alignItems:'center',gap:16,marginBottom:24,padding:'16px',background:'var(--bg3)',borderRadius:10}}>
                <div style={{width:64,height:64,borderRadius:'50%',background:'linear-gradient(135deg,var(--accent),#c4780a)',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'var(--syne)',fontWeight:800,fontSize:22,color:'#000',flexShrink:0}}>DM</div>
                <div>
                  <div style={{fontFamily:'var(--syne)',fontWeight:700,fontSize:16}}>{profile.name}</div>
            ...
            {[
              ...
              <div key={p.key} style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'14px 0',borderBottom:'1px solid var(--border)'}}>
                ...
                <div onClick={()=>setPrefs(x=>({...x,[p.key]:!x[p.key]}))} style={{
                  ...
                  background:prefs[p.key]?'var(--accent)':'rgba(255,255,255,0.15)',
            ...
            <div className="card-body">
              ...
              {[{label:'Compact View',desc:'Show denser tables and cards',key:'compactView'}].map(p=>(
                <div key={p.key} style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 0',borderTop:'1px solid var(--border)',marginTop:8}}>
                  ...
                  <div onClick={()=>setPrefs(x=>({...x,[p.key]:!x[p.key]}))} style={{width:44,height:24,borderRadius:12,cursor:'pointer',flexShrink:0,background:prefs[p.key]?'var(--accent)':'rgba(255,255,255,0.15)',position:'relative',transition:'background .2s'}}>
                ...
                <tr key={m.name}>
                  <td>
                    <div style={{display:'flex',alignItems:'center',gap:10}}>
                      <div style={{width:32,height:32,borderRadius:'50%',background:['#e8a020','#3b82f6','#22c55e','#a855f7','#ef4444','#06b6d4'][i],display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'var(--syne)',fontWeight:700,fontSize:12,color:'#000',flexShrink:0}}>
          ...
          {[
            ...
            <div key={intg.name} className="card">
              <div className="card-body">
                ...
                <div style={{fontFamily:'var(--syne)',fontWeight:700,fontSize:14,marginBottom:4}}>{intg.name}</div>
