          ...
          <>
            ...
            <div style={{
              ...
              <div style={{ padding:'14px 16px 10px', borderBottom:'1px solid var(--border)', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                <div style={{ fontFamily:'var(--syne)', fontWeight:700, fontSize:14 }}>
                  Notifications
                  {unread > 0 && <span style={{ background:'var(--accent)', color:'#000', fontSize:10, fontWeight:700, padding:'1px 6px', borderRadius:10, marginLeft:6 }}>{unread}</span>}
                </div>
                {unread > 0 && (
