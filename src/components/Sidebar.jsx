...
const NAV_MAIN = [
  ...
  { to:'/inventory', label:'Vehicle Inventory',icon:'car',    badge:'10'  },
  { to:'/leads',     label:'Lead Management',  icon:'users',  badge:'8'   },
  { to:'/sales',     label:'Sales & Deals',    icon:'calc',   badge:null  },
  { to:'/fi',        label:'F&I Integration',  icon:'card',   badge:'5'   },
    ...
    <aside className={`sidebar${isOpen ? ' open' : ''}`}>
      ...
      <div className="sidebar-logo">
        ...
        <button onClick={onClose} className="sidebar-close-btn" style={{
          ...
          lineHeight:1, padding:'0 4px', display:'none'
        }}>&#x2715;</button>
      </div>
